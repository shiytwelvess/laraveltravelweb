                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card-details">
                                        <h3 class="product-card-title">
                                            <a href="collection-left-sidebar.html" class="text-15"><b>{{ $value->tenKhachSan }}</b></a>
                                            <div class="text-14 "><b>Địa Chỉ :</b> {{$value->diaChi}}</div>
                                            <div class="text-14 "><b>Trải Nghiệm :</b> {{$value->soNgay}}Ngày , {{$value->soDem}}Đêm</div>
                                            <p class="text-14 "><b class="text-danger">Giá Tour Từ :</b><ul class="money-list">
