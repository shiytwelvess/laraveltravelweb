                ...
                <div class="card">
                    ...
                    <div class="blog-post-item blog-details-wrap">
                        ...
                        <div class="blog-post-content ">
                            ...
                            {{-- <p style="font-size:20px ;magrin-left:1rem" > &emsp;{{ $blogDetail->noi_dung }}</p> --}}
                        </div>
            ...
            <div class="d-flex comments-item">
                ...
                <div class="comments-main">
                    <div class="comments-main-content">
                        ...
                        <button type="button"
                            class="btn-reply bg-transparent d-flex align-items-center">
                            <span class="btn-reply-icon me-2">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="form-header">
                    ...
                    @else
                            ...
                            {{-- <a href=""><button type="submit"
                                class="position-relative review-submit-btn mt-4">Đăng Nhập</button></a> --}}
