                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-nowrap text-danger">Tên Khách Sạn</th>
                                <th class="text-center text-nowrap text-danger">Số Lượng Phòng</th>
                        ...
                        <tbody>
                            <tr v-for="(value, key) in list_hoa_don">
                                ...
                                <th class="text-nowrap text-center align-middle">@{{ value.tenKhachSan }}</th>
                                <th class="text-nowrap text-center align-middle">@{{ value.soPhong }}</th>
