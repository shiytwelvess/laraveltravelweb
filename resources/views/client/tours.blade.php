                        ...
                        <div class="product-card" style="border: 1px solid #ccc; border-radius: 5px; padding: 5px;">
                            ...
                            <div class="product-card-details">
                                <h3 class="product-card-title">
                                    ...
                                    <p class="text-14">Lịch trình:<br>Từ: {{Carbon\Carbon::parse($value->thoiGianBatDau)->format('H:i d/m/Y')}}<br>Đến: {{Carbon\Carbon::parse($value->thoiGianKetThuc)->format('d/m/Y H:i')}}</p>
                    ...
                    <div class="common-slider" data-slick='{
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="https://www.pullman-danang.com/vi/kham-pha/kham-pha/cay-cau-noi-tieng-tai-da-nang/">
                                    <img style="height:290px ;width:420px" src="https://halotravel.vn/wp-content/uploads/2021/07/cau-quay-song-han-1.jpg" alt="img"
                                ...
                                <p class="article-card-published text_12 d-flex align-items-center">
                                    ...
                                    <span class="article-author d-flex align-items-center ms-4">
                                        ...
                                        <span class="ms-2">Kai</span>
                                    </span>
                                </p>
                                <h2 class="article-card-heading heading_18">
                                    <a class="heading_18" href="https://www.pullman-danang.com/vi/kham-pha/kham-pha/cay-cau-noi-tieng-tai-da-nang/">
                                    Cầu Sông Hàn
                                    </a>
                                </h2>
                            </div>
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="https://www.pullman-danang.com/vi/kham-pha/kham-pha/cay-cau-noi-tieng-tai-da-nang/">
                                    <img style="height:290px ;width:420px" src="https://cdn.vntrip.vn/cam-nang/wp-content/uploads/2016/01/cau-thuan-phuoc.jpg" alt="img"
                                        class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="https://www.pullman-danang.com/vi/kham-pha/kham-pha/cay-cau-noi-tieng-tai-da-nang/">
                                    <img style="height:290px ;width:420px" src="https://d2e5ushqwiltxm.cloudfront.net/wp-content/uploads/sites/86/2020/02/18083933/Dragon-Bridge-has-a-unique-architecture-in-Vietnam-c%E1%BA%A7u-r%E1%BB%93ng-%C4%91%C3%A0-n%E1%BA%B5ng-Danang-Discovery-4-famous-bridge-in-danang-a-new-iconic-image-of-danang-experience-in-danang-dragon-bridge-history.jpg" alt="img"
                                        class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="https://www.pullman-danang.com/vi/kham-pha/kham-pha/cay-cau-noi-tieng-tai-da-nang/">
                                    <img style="height:290px ;width:420px" src="https://tourdanangcity.vn/wp-content/uploads/2022/03/cau-da-nang-5.jpg.jpg?v=1647786647" alt="img"
                                        class="article-card-img rounded">
