...
<head>
    {{-- <!--Start of Fchat.vn-->
    <script type="text/javascript" src="https://cdn.fchat.vn/assets/embed/webchat.js?id=643762b79e2b20021f1045b2"
        async="async"></script>
    <!--End of Fchat.vn--> --}}
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Merriweather:wght@300&family=Sarabun:wght@100;300;400;500;700;800&family=Vina+Sans&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" href="/assets_rocker/css/style.css">
</head>
    ...
    <div class="body-wrapper">
            ...
            <div class="header-bottom">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-2 col-md-4 col-4">
                            <div class="header-logo">
                                <a href="/" class="logo-main">
                                    <img style="height: 70px ; width :120px"
                                        src="/assets_rocker/images/banner/travel_2.jpg" loading="lazy" alt="bisum">
                                </a>
                            </div>
                        </div>
                                    ...
                                    <li class="menu-list-item nav-item has-dropdown">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="/tours">
                                                <b style="font-size:20px">Tours</b>
                                            </a>
                                        </div>
                                    </li>
                                    <li class="menu-list-item nav-item has-megamenu">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="/khach-san/index">
                                                <b style="font-size:20px">Khách Sạn</b>
                                            </a>
                                        </div>
                                    </li>
                                    <li class="menu-list-item nav-item has-dropdown">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="/khampha/index" style="font-size:20px"><b>Khám Phá</b>
                                            </a>
                                        </div>
                                    </li>
                                    <li class="menu-list-item nav-item has-dropdown">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="/blog/index" style="font-size:20px"><b>Bài Viết</b>
                                            </a>
                                        </div>
                                    </li>
                                    <li class="menu-list-item nav-item">
                                        <a class="nav-link" href="/lien-he" style="font-size:20px"><b>Liên Hệ</b></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                        <div class="col-lg-2 col-md-7 col-7">
                            <div class="header-action d-flex align-items-center justify-content-end">
                                ...
                                @endphp
                                @if ($check)
                                <div class="menu-list-item nav-item has-dropdown" style="margin-left:10px">
                                    <div class="mega-menu-header " >
                                        <a class="nav-link" href="/"><i class="fa-solid fa-user" style="font-size:20px; margin-top:2px ;margin-left : 3%"></i></i></a>
                                    </div>
                                    <div class="submenu-transform submenu-transform-desktop">
                                        <ul class="submenu list-unstyled">
                                            <li class="menu-list-item nav-item-sub">
                                                <a class="nav-link-sub nav-text-sub" href="http://127.0.0.1:8000/cap-nhap-thong-tin/index"><i class="fa-regular fa-user"></i> Trang Cá Nhân</a>
                                            </li>
                                            <li class="menu-list-item nav-item-sub">
                                                <a class="nav-link-sub nav-text-sub" href="http://127.0.0.1:8000/bill-khach-san/index"> <i class="fa-solid fa-wallet"></i> Hóa Đơn Khách Sạn</a>
                                            </li>
                                            <li class="menu-list-item nav-item-sub">
                                                <a class="nav-link-sub nav-text-sub" href="http://127.0.0.1:8000/bill-tour/index"><i class="fa-solid fa-money-bill"></i> Hóa Đơn Tour</a>
                                            </li>
                                            <li class="menu-list-item nav-item-sub">
                                                <a class="nav-link-sub nav-text-sub" href="http://127.0.0.1:8000/logout"> <i class="fa-solid fa-right-from-bracket"></i> Đăng Xuất</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                @else
                                <div class="menu-list-item nav-item has-dropdown">
                                    <div class="mega-menu-header">
                                        <a class="nav-link" href="/"><i class="fa-solid fa-user" style="font-size:20px; margin-top:2px ;margin-left : 3%"></i></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="search-wrapper">
                        <div class="container">
                            <form action="/tim-kiem" method="post" class="search-form d-flex align-items-center">
                                @csrf
                                ...
                                <div class="search-input mr-4">
                                    <input name="search" type="text" placeholder="Nhập thông tin tìm kiếm...."
                                        autocomplete="off">
                                </div>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="drawer-cart">
            <div class="offcanvas-header border-btm-black">
                <h5 class="cart-drawer-heading text_16">Đặt vé</h5>
                ...
                <div class="cart-content-area d-flex justify-content-between flex-column">
                    ...
                    <div class="minicart-footer">
                        <div class="minicart-calc-area">
                            ...
                            <p class="cart-taxes text-center my-4">Chúc các có một chuyến trải nghiệm đáng nhớ!!
                            </p>
                        </div>
                        <div class="minicart-btn-area d-flex align-items-center justify-content-between">
                            <a href="/dat-ve" class="minicart-btn btn-secondary">Giỏ hàng</a>
