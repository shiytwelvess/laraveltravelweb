    ...
    <div class="wishlist-page" style="margin-top: 30px">
        <div class="wishlist-page-inner">
            <div class="container">
                ...
                <div class="col-lg-6 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card" style="border: 1px solid #ccc; border-radius: 5px; padding: 5px;">
                                <a class="hover-switch" href="http://127.0.0.1:8000/chi-tiet-dia-diem/{{$value->id}}">
                                    <img style="height: 300px ;width:100%" class="primary-img" src="{{ $value->hinh_anh }}" alt="">
                                </a>
                            <div class="product-card-details">
                                    <h3 class="product-card-title">
                                    <a href=""><b>{{ $value->tenDiaDiem }}</b></a><br>
                                    <div><b>Địa Chỉ :</b>{{$value->diaChi}}</div>
                                </h3>
                            </div>
                            <button  class="btn btn-view-details" style="background-color: #00aaff; color: #fff; width: 100%; padding: 5px 10px; border-radius: 3px; border: none; margin-top: 5px;" onclick="window.location.href='http://127.0.0.1:8000/chitietkhampha/{{$value->id}}'">Xem chi tiết</button>
                        </div>
                 </div>
                  @endif
                @endforeach
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="/blog/detail/{{$value->id}}"><h2 class="article-title">{{ $value->tieuDe }}</h2></a>
                                            <div class="article-content">
                                                <p style="font-size:20px"> &emsp; {{ $value->moTaNgan}}</p>
                                             </div> --}}
                                            {{-- <div class="article-content">
                                ...
                                <div class="related-item related-item-article d-flex">
                                    ...
                                    <div class="related-product-info">
                                        <h6 class="related-heading text_14">
                                            <a href="/blog/detail/{{$value->id}}">{{$value->tieuDe}}</a>
                                        </h6>
