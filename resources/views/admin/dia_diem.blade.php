            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="" id="" class="form-control mb-2" v-model='create_dia_diem.trangThai'>
                            ...
                            <tbody v-for='(value , key) in list_dia_diem'>
                                ...
                                <td class="text-center align-middle">
                                    <button class="btn btn-info" v-on:click="moTa = value.moTa" data-bs-toggle="modal"
                                        data-bs-target="#motanganModal">Xem</button>
                                </td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <!-- Thay vì sử dụng textarea, bạn có thể dùng div với CKEditor -->
                                    <div id="ckeditorInstance" class="form-control"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="">Tên Địa Điểm</label>
                                        <input v-model="update_dia_diem.tenDiaDiem" type="text"
                                    ...
                                    <div class="form-group">
                                        <label for="">Thông Tin Liên Lạc</label>
                                        <input v-model="update_dia_diem.lienLac" type="text"
                                            class="form-control mb-2">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Trạng Thái</label>
                                        <select name="" id="" class="form-control mb-2"
                                            v-model="update_dia_diem.trangThai">
                                            <option value="1">Đang Hoạt Động</option>
                                            <option value="0">Dừng Hoạt Động</option>
                                        </select>
                                    </div>
...
@section('js')
    ...
    <script>
        // Khởi tạo CKEditor sau khi modal được hiển thị
        $('#motanganModal').on('shown.bs.modal', function() {
            // Khởi tạo CKEditor cho div
            CKEDITOR.replace('ckeditorInstance', {
                readOnly: true // Đặt chế độ chỉ đọc nếu không cho phép chỉnh sửa
            });
        });
        $('#motanganModal').on('hidden.bs.modal', function() {
            // Xóa CKEditor khi modal đóng
            if (CKEDITOR.instances['ckeditorInstance']) {
                CKEDITOR.instances['ckeditorInstance'].destroy();
            }
        });
    </script>
@endsection
