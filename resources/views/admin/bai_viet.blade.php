    ...
    <div class="col-md-12 mt-3">
        <div class="card border-primary border-bottom border-3 border-0">
            <div class="card-header">
                <strong> <h4>Thêm Mới Bài Viết</h4></strong>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <label class="form-label">Tiêu đề</label>
                        <input type="text" v-model="them_moi.tieuDe" class="form-control">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea v-model="them_moi.moTaNgan" class="form-control" cols="30" rows="5"></textarea>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">Nội dung chính bài viết</label>
                        <textarea v-model="them_moi.noiDung" class="form-control" cols="30" rows="10"></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(value, key) in list_bai_viet">
                                ...
                                <td class="text-nowrap align-middle">@{{ value.tieuDe }}</td>
                                ...
                                <td class="text-center align-middle">
                                    <button class="btn btn-info" v-on:click="moTaNgan = value.moTaNgan" data-bs-toggle="modal" data-bs-target="#motanganModal">Mô tả ngắn</button>
                                </td>
                                <td class="text-center align-middle">
                                    <button class="btn btn-info" v-on:click="noiDung = value.noiDung" data-bs-toggle="modal" data-bs-target="#noidungModal">Nội dung</button>
                                </td>
                                <td class="text-nowrap align-middle text-center">
                                    <button v-on:click="doiTrangThai(value.id)" v-if="value.trangThai == 1" class="btn btn-success">Hiển thị</button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="form-label">Tiêu đề</label>
                                        <input type="text" v-model="edit.tieuDe" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Hình ảnh</label>
                                        <div class="input-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="form-label">Mô tả ngắn bài viết</label>
                                        <textarea v-model="edit.moTaNgan" class="form-control" cols="30" rows="5"></textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Nội dung chính bài viết</label>
                                        <textarea v-model="edit.noiDung" class="form-control" cols="30" rows="10"></textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal fade" id="motanganModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <textarea disabled cols="30" rows="10" class="form-control">@{{moTaNgan}}</textarea>
                            </div>
                            <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                            </div>
