            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea id="moTa-editor" v-model='them_moi.noi_dung' class="form-control" cols="30" rows="10"></textarea>
                    </div>
                    {{-- <div class="col-md-12">
    ...
    new Vue({
        ...
        methods :   {
            createBaiViet(){
                ...
                this.them_moi.noi_dung = editorData;
...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function () {
        CKEDITOR.replace('moTa-editor').on('change', () => {
            this.them_moi.moTa = CKEDITOR.instances['moTa-editor'].getData();
        });
    });
    </script>
@endsection
